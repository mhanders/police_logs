class LogParser(object):
    ...
    def _chunk(self, chunk_list, chunk_length):
        ...
        chunks = [chunk_list[(i - 1) * chunk_length: i * chunk_length]
                  for i in xrange(1, num_chunks)]
        trailing_chunk = chunk_list[(num_chunks - 1) * chunk_length:]

        # Need to fix the final comments of the trailing chunk, which could be
        # multiline
        trailing_chunk, comment = trailing_chunk[
            :chunk_length - 1], trailing_chunk[chunk_length - 1:]
